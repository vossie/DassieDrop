...
- Added optional per-user authenticator app login codes with dependency-free TOTP and QR-code setup, including shorter Google Authenticator-compatible QR payloads, stable pending setup secrets, visible server time, and wider clock-skew tolerance.
